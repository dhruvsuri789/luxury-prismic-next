 ...
 */
export type FragranceDocument<Lang extends string = string> = prismic.PrismicDocumentWithUID<
...
export type AllDocumentTypes = FragranceDocument | PageDocument | SettingsDocument;
